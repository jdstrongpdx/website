function Ffr() {
    ...
    <ul>
        ...
        <li>Pagination - Used Spring Boot Pageable and React-Bootstrap Pagination to deliver paginated result
            lists to the user.
        </li>
    ...
    <ul>
        ...
        <li>Learn to implement more complicated features and design patterns of a Spring Boot application using a MVC model, REST APIs, Spring Security for user Auth using JWTs, JPA ODM, DTOs, Mappers and OOP.</li>
        ...
        <li>Learning to use Typescript and Bootstrap. Fortunately Typescript and Java are similar in their typing and syntax, so it was easier to learn than I had initially expected.</li>
        <li>Learning more complicated React implementations using Components, Props, State, Hooks, Contexts, Event Handling and Conditional Rendering.</li>
        <li>Using Postman/Newman to design and test API endpoints.</li>
        <li>Configuring and working with local development environments and remotely hosted production environments.</li>
        ...
        <li>Gain experience testing different designs and evaluating the tradeoffs of different design choices.</li>
    </ul>
