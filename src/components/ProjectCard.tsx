        ...
        >
            ...
            {project.image
                ? <div className="card-content">
                    ...
                    {project.stack?.frontend && <p className="card-text">
                        <strong>Front-End:</strong> {project.stack.frontend}</p>}
                    {project.stack?.database && <p className="card-text"><strong>Database:</strong> {project.stack.database}</p>}
                    {project.stack?.backend && <p className="card-text"><strong>Backend:</strong> {project.stack.backend}</p>}
                    {project.stack?.hosting && <p className="card-text"><strong>Hosting:</strong> {project.stack.hosting}</p>}
