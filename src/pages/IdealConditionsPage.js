...
<section>
        ...
        <h2>About this Project</h2>
            <article>
                ...
                <p>TODO INCLUDE 6 MINUTE VIDEO ON PROJECT</p>
                <p>TODO INCLUDE GITHUB LINK</p>
            </article>
        ...
        <article>
          <p><strong>Legal Disclaimer: </strong>This website makes no guarantees as to the accuracy of the information provided. Participation in outdoor activities carries inherent risks and the user accepts all responsibility to verify the weather conditions, safety, and abilities to participate in any activity listed or not.
          </p>
        </article>

        <p>For support or questions about this website, contact <a href="mailto:info@jdstrongpdx.com">info@jdstrongpdx.com</a></p>
      </section>
